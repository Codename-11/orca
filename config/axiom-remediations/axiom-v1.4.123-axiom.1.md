...
- Original Actions run: https://github.com/Codename-11/orca/actions/runs/28752047763
- Upstream ref/tag: v1.4.123
- Intended Axiom version/tag: 1.4.123-axiom.1 / axiom-v1.4.123-axiom.1
- Target branch: `axiom/deploy`
- Bot branch: `bot/upstream-sync-axiom-v1.4.123-axiom.1`
...
M  src/main/ghostty/mapper-extended.test.ts
...
M  src/main/github/pr-review-comment-lines.test.ts
M  src/main/github/pr-review-comment-lines.ts
...
M  src/main/ipc/ephemeral-vm-runtime-handlers.ts
M  src/main/ipc/ephemeral-vm.test.ts
... omitted 575 additional status records to keep remediation payloads within GitHub limits.
```
