...
- Original Actions run: https://github.com/Codename-11/orca/actions/runs/28617754833
- Upstream ref/tag: v1.4.117
- Intended Axiom version/tag: 1.4.117-axiom.1 / axiom-v1.4.117-axiom.1
- Target branch: `axiom/deploy`
- Bot branch: `bot/upstream-sync-axiom-v1.4.117-axiom.1`
...
A  docs/reference/terminal-switch-typing-lag-investigation.md
...
... omitted 1654 additional status records to keep remediation payloads within GitHub limits.
```
