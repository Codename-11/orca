...
- Original Actions run: https://github.com/Codename-11/orca/actions/runs/27661552629
- Upstream ref/tag: v1.4.74
- Intended Axiom version/tag: 1.4.74-axiom.1 / axiom-v1.4.74-axiom.1
- Target branch: `axiom/deploy`
- Bot branch: `bot/upstream-sync-axiom-v1.4.74-axiom.1`
...
A  docs/terminal-close-confirmation.md
...
M  src/main/observability/diagnostic-bundle-limits.ts
M  src/main/observability/diagnostic-bundle-upload.ts
A  src/main/observability/diagnostic-upload-endpoint.ts
M  src/main/observability/redactor.ts
...
A  src/main/star-nag/prompt-session-telemetry.ts
...
M  src/relay/git-handler-push-target.ts
...
M  src/renderer/src/components/crash-report/CrashReportDialogSurface.tsx
...
A  src/renderer/src/components/hover-reveal-touch-action-visibility.test.ts
M  src/renderer/src/components/mobile/mobile-platform-copy.ts
M  src/renderer/src/components/new-workspace/ProjectCombobox.test.tsx
M  src/renderer/src/components/new-workspace/ProjectCombobox.tsx
A  src/renderer/src/components/new-workspace/SmartWorkspaceNameField-provider-boundaries.test.ts
...
M  src/renderer/src/components/new-workspace/smart-workspace-command-value.test.ts
M  src/renderer/src/components/new-workspace/smart-workspace-command-value.ts
...
A  src/renderer/src/components/right-sidebar/source-control-header-icon-button.tsx
A  src/renderer/src/components/right-sidebar/source-control-header-overflow-menu.tsx
A  src/renderer/src/components/right-sidebar/source-control-header-toolbar.test.ts
A  src/renderer/src/components/right-sidebar/source-control-header-toolbar.tsx
A  src/renderer/src/components/right-sidebar/source-control-linked-review-primary-action.ts
...
M  src/renderer/src/components/settings/MobilePairingQrSection.tsx
...
D  src/renderer/src/components/sidebar/FolderWorkspaceComposerDialog.tsx
M  src/renderer/src/components/sidebar/HostSectionHeaderMenu.tsx
...
A  src/renderer/src/components/sidebar/folder-workspace-composer-helpers.test.ts
M  src/renderer/src/components/sidebar/folder-workspace-composer-helpers.ts
M  src/renderer/src/components/sidebar/folder-workspace-composer-path-status.test.tsx
M  src/renderer/src/components/sidebar/folder-workspace-composer-path-status.ts
...
M  src/renderer/src/components/sidebar/workspace-kanban-sidebar-drop.test.ts
M  src/renderer/src/components/sidebar/workspace-kanban-sidebar-drop.ts
...
A  src/renderer/src/components/sidebar/worktree-list-host-filtering.test.ts
...
A  src/renderer/src/lib/gitlab-work-item-source-lookup.test.ts
A  src/renderer/src/lib/gitlab-work-item-source-lookup.ts
...
A  src/shared/git-configured-branch-target.ts
...
A  src/shared/git-remote-branch-name.ts
...
M  src/shared/shell-process-detection.ts
