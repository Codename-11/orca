/* eslint-disable max-lines -- Why: WSL CLI registration needs broad Windows/WSL
   edge-case coverage in one fixture-backed suite to keep launcher behavior coherent. */
