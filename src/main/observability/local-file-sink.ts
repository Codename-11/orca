...
//
// Defaults match T3 Code's TraceSink: 10 MB × 10 files. 100 MB is the worst-
// case footprint on a user's disk; T3 Code has shipped with these defaults
// without complaints, so the sizing is well-trodden ground.
//
