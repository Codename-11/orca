...
export function getDefaultSettings(homedir: string): GlobalSettings {
  return {
    ...
    defaultForgeViewMode: 'list',
    defaultForgeSort: { key: 'updated', direction: 'desc' },
    defaultForgePreset: 'active',
    defaultForgeAgentFilter: 'all-agents',
    defaultForgeProjectFilterId: null,
