...
,
  {
    title: translate('auto.components.settings.integrations.search.56f51dfc78', 'Forge Integration'),
    description: translate(
      'auto.components.settings.integrations.search.7dc28b54fa',
      'Connect Forge to browse and manage Forge issues.'
    ),
    keywords: [
      ...translateSearchKeyword('auto.components.settings.integrations.search.c13e7db351', 'forge'),
      ...translateSearchKeyword(
        'auto.components.settings.integrations.search.c450244ad7',
        'integration'
      ),
      ...translateSearchKeyword('auto.components.settings.integrations.search.2ec54bee51', 'tasks'),
      ...translateSearchKeyword(
        'auto.components.settings.integrations.search.faa0b5a0d9',
        'api key'
      ),
      ...translateSearchKeyword('auto.components.settings.integrations.search.b60d106315', 'token'),
      ...translateSearchKeyword('auto.components.settings.integrations.search.f025f7fd79', 'base url'),
      ...translateSearchKeyword(
        'auto.components.settings.integrations.search.27ce39bc99',
        'project manager'
      )
    ]
  }
